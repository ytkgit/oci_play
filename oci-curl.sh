...
function oci-curl {
	...
	local tenancyId="ocid1.tenancy.oc1..aaaaaaaazbumdodbygqaby3ryd3bav5vuiwrn2ujhgqj7nvsncn2jxampv2a";
	local authUserId="ocid1.user.oc1..aaaaaaaa3ku44godcrxmezt2t7xwzxjwy73ezccm33ityfxuep52twzbdyra";
	local keyFingerprint="a4:35:62:cd:0f:3a:08:b6:9a:ba:98:10:c1:f4:e9:b0";
